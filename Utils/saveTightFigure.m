function saveTightFigure(h,outfilename, params)
...
set(hfig, 'position', [p(1) p(2) width*1.01 height]);
%% set papersize
set(hfig,'PaperUnits','centimeters');
set(hfig,'PaperSize', [width*params.wscale height*params.hscale]);
set(hfig,'PaperPositionMode', 'manual');
set(hfig,'PaperPosition',[0 0 width height]);


%% save
if strcmp(outfilename(end-2:end),'eps')
    saveas(hfig,outfilename,'epsc');
else
